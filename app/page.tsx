...
export const metadata: Metadata = {
  ...
  description:
    'Looking for a locksmith near you in Sanford, FL? Daniel Cerda Locksmith is your local licensed 24/7 locksmith — car lockouts, home lockouts, rekeying, car key replacement, smart locks. 20-minute response. Licensed & insured. Call (917) 203-4678.',
  keywords:
  ...
  openGraph: {
    ...
    description:
      'Local licensed locksmith in Sanford, FL. Car lockouts, home rekeying, key replacement, smart locks. 20-30 minute response. Call (917) 203-4678.',
    url: SITE.url,
    type: 'website',
  },
}
